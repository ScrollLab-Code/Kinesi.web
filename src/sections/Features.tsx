export default function Features() {
  const featuresList = [
    ...
    },
    {
      ...
      description: "Atlas fotográficos comentados, flashcards de Anki listas para importar y desgrabados recomendados por acompañantes académicos.",
      svgIcon: (
        <svg className="h-7 w-7 text-emerald-800" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-14 max-w-3xl">
          ...
          <p className="mt-3 text-sm text-slate-500">
            Combinamos comunidad colaborativa, catálogo de materiales verificados y acompañamiento académico individual.
          </p>
        </div>
